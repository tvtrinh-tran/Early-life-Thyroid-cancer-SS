...
#Analyses for age started using hormonal birth control, age started drinking regularly, and age started smoking: exclude individuals who reported starting at 20 years of age or older
#Disregard HRs and 95%CIs for age started using hormonal birth control, age started drinking regularly, and age started smoking from the cox_childhood above

rep_bc_min_age=cox_model(surv = "Surv(ident_ageexact_bl, ident_EOF, ident_DTC)",
                             var_name = "rep_bc_min_age_cat",
                             var_label = list("rep_bc_min_age_cat" ~ "Start age for hormonal birth control"),
                             covar = covariates_childhood,
                             data=earlylife_popu[earlylife_popu$rep_bc_min_age_cat!="Started at 20 years of age or older",])|>sort_childhood()

alc_age_start_reg=cox_model(surv = "Surv(ident_ageexact_bl, ident_EOF, ident_DTC)",
                             var_name = "alc_age_start_reg_cat",
                             var_label = list("alc_age_start_reg_cat" ~ "Age started drinking regularly"),
                             covar = covariates_childhood,
                             data=earlylife_popu[earlylife_popu$alc_age_start_reg_cat!="20 years of age or older",])|>sort_childhood()

sm_age_start_smok=cox_model(surv = "Surv(ident_ageexact_bl, ident_EOF, ident_DTC)",
                             var_name = "sm_age_start_smok_cat",
                             var_label = list("sm_age_start_smok_cat" ~ "Age started smoking and number of pack-years"),
                             covar = covariates_childhood,
                             data=earlylife_popu[earlylife_popu$sm_age_start_smok_cat!="20 years of age or older",])|>sort_childhood()

sm_pack_yr_before20=cox_model(surv = "Surv(ident_ageexact_bl, ident_EOF, ident_DTC)",
                             var_name = "sm_pack_yr_before20_cat",
                             var_label = list("sm_pack_yr_before20_cat" ~ "Smoking before 20 (Pack-years)"),
                             covar = covariates_childhood,
                             data=earlylife_popu[earlylife_popu$sm_pack_yr_before20_cat!="Started after 20",])|>sort_childhood()
...
png(filename=here::here("original_figures/child_teen_bmi_weight_strat.png"),pointsize=14,width = 2400, height = 1500)
