...
Thyroid cancer has emerged as the fifth most common cancer in women globally, with its rapid increased incidence over several decades. Considering that the increase was observed in both small, indolent tumors and advanced cases, there is increasing recognition that the increase is attributed to both overdiagnosis and exposures to environmental and hormonal factors. However, beyond the two well-established risk factors---childhood exposure to ionizing radiation and obesity, the etiology of thyroid cancer remaines largely elusive.

Given that thyroid cancers are diagnosed at younger ages compared to other types of cancer,^8^ evaluating risk factors during in utero periods is of particular interest as it could be a critical time window of exposure regarding carcinogenesis. In vitro and in vivo studies have shown that during the second and the third trimester, thyroid gland is highly susceptible to thyroid autoimmunity, iodine deficiency, and circulating concentrations of growth hormone and IGF-I, which have been suggested as having carcinogenic influences. However, few epidemiological studies have assessed the influence of in utero exposures on thyroid cancer incidence, and the findings are inconsistent. Some suggest an increased risk of thyroid cancer associated with in utero and infancy factors indicating the growth regulation (e.g., higher birthweight,9,10), the abnormal thyroid hormone exposures (per se or through the mother\'s metabolic conditions),10,11, whereas others report either little effects or a decreased risk. Findings on other factors, e.g., maternal age, smoking, are also limited and yielded conflicting results (ref: <https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9473679/pdf/nihms-1799998.pdf>). These inconsistencies could be explained by challenges that epidemiological studies on early-life factors and thyroid cancer development often carry, such as limited and inaccurate data on potential
exposures and confounders, the long latency period between exposures and thyroid cancer onset[,]{.underline} the
[limited number of cases]{.underline}, the large number of subjects that must be studied, (<https://pubmed.ncbi.nlm.nih.gov/22527169/> ), and limited assessment of detection bias to account for overdiagnosis. Taken together, the associations of in-utero exposure with thyroid cancer incidence in adulthood remains poorly und

In the current study, we evaluated the association between different in-utero and infancy factors and thyroid cancer risk in the Sister Study, a large U.S. nationwide cohort which include 50xxx female participants and xxx cases of thyroid cancer. The Sister Study collected a wide array of information on in-utero and infant exposure and comprehensive details on thyroid cancer incidence, providing an opportunity to provide insights into the association betweenearly life exposures and thyroid cancer while addressing many of the afore-mentioned issues.

## Methods

### Study population:

Details of the study design, data collection, and outcome measurements of the Sister Study cohort are described elsewhere. Briefly, between 2003 and 2009, the Sister Study recruited a total of 50884 women aged 35 to 74 residing in the United States (including Puerto Rico) who had a sister diagnosed with breast cancer but no prior diagnosis with the disease themselves. At baseline, participants provided detailed information on early-life, demographic, medical, lifestyle, and reproductive factors through computer-assisted telephone interviews and written questionnaires. anthropometric measurements were also collected during in-person examinations. After the baseline, the Sister Study sends the participants detailed follow-up questionnaires every 2-3 years, and when necessary, contacted them through telephone calls, e-mails, or correspondence. The response rates to the follow-up questionnaires reached 85% or more (refs). The Sister Study was approved by National Institute of Environmental Health Services/NIH and Copernicus Group Institutional Review Boards, and all participants provided written informed consent.
...
The baseline descriptive statistics are provided in Table 1. Most participants were non-Hispanic Whites (n=39863, 83%) and the median age at baseline was 55.4 (Interquartile range, IQR, 48.9-62.1). Of the 47810 women included in the study, 30% (n=14315) reported having a BMI of 30 or more and 43.1% (n=20740) smoked at or prior to baseline.
