...
earlylife_popu=earlylife_popu|>
  mutate(ident_DTC_PTC=ifelse(ident_DTC_histo=="2) PTC",1,0),
         ident_DTC_stageI=ifelse(ident_DTC_stage_AJCC7=="2) I",1,0),
         ident_DTC_adv_stage=ifelse(ident_DTC_stage_AJCC7%in%c("3) II","4) III"),1,0),
         ident_DTC_1cm=ifelse(ident_DTC_size=="2) <1 cm",1,0),
         ident_DTC_large_tumor=ifelse(ident_DTC_size%in%c("3) 1-2 cm","4) 2-4 cm","5) 4 cm or more"),1,0))
...
#| cache: true
#| dependson: c("data", "var-list-utero", "functions","tbl-utero")
#| cache.extra: !expr file.mtime("C:/Users/trant4/OneDrive - National Institutes of Health/Trinh/Postdoc NCI - Risk factors and thyroid cancer/SS/data/ss_earlylife_popu.csv")
#return the table 
cox_utero
```
...
cox_adv_stage_utero = cox_model(
  ...
  covar = covariates_utero,
  data = earlylife_popu,
  model_name = "Advanced stage cancer"
)|> sort_birth_weight()
...
cox_1cm_utero = cox_model(
  ...
  covar = covariates_utero,
  data = earlylife_popu,
  model_name = "Tumor size of less than 1 cm"
)|> sort_birth_weight()
...
cox_large_tumor_utero = cox_model(
  ...
  covar = covariates_utero,
  data = earlylife_popu,
  model_name = "Tumor size of 1 cm or more"
)|> sort_birth_weight()
...
#| dependson: c("data", "var-list-utero", "functions")
#| cache.extra: !expr file.mtime("C:/Users/trant4/OneDrive - National Institutes of Health/Trinh/Postdoc NCI - Risk factors and thyroid cancer/SS/data/ss_earlylife_popu.csv")
multivariate_evalues=multivariate_utero|>polish_childhood(group_name = TRUE)
Evalues=cbind(multivariate_evalues$`_data`$estimate,multivariate_evalues$`_data`$conf.low,multivariate_evalues$`_data`$conf.high)
...
## Supplementary table 4: Association between birth weight and thyroid cancer risk, after excluding participants who were born more than 2 weeks before due date or those who were part of a multiple birth
