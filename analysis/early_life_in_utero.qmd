...
###"ui_DES"~"DES use",                                                        #not included because of number of cases<5
  ...
  "ui_preg_order_cont"~"Birth order (kg, continuous)",
...
cox_complete = tbl_stack(list(cox_complete_ges_hypertension, cox_complete_ges_diab, cox_complete_birth_weight_cat, cox_complete_birth_weight_cont, cox_complete_early_gest))|>
  polish_utero()
```
